    ...
    <body>
        ...
        <main  class="pt-0">
            <section class="w-full flex-col justify-center items-center gap-40 pv-80">
                <h1 class="text-5xl font-normal text-center leading-none uppercase">
                    C'est ici que vous faites
                    <br />
                    <span class="text-7xl font-bold">le meilleur choix</span>
                </h1>
                
                <div class="w-75 bg-tertiary rounded-full ph-80 pv-20">
            ...
            <section id="products__card" class="flex-col gap-20 w-full"></section>
        </main>
