<?php
    require('./php/function_products.php');

    $currentCategory = $_GET['category'] ?? 'dishes';
?>
...
<html lang="fr-FR">
    ...
    <body>
        <header>
            <section class="header__container flex-row justify-between items-center w-full h-full">
                ...
                <div class="header__menu flex-row justify-between items-center gap-32">
                    <a href="/">Accueil</a>
                    <a href="./products.php" id="active__menu">La carte</a>
                </div>
                <div class="header__right flex-row items-center gap-24">
                    ...
                    <a class="btn btn-svg btn-primary" href="./connection.html">
        ...
        <main class="pt-0">
            <section class="w-full flex-col justify-center items-center gap-40 pv-80">
                <h1 class="text-5xl font-normal text-center leading-none uppercase sm-text-2xl">
                    ...
                    <ul class="flex-row justify-between items-center">
                        <li>
                            <a href="?category=dishes" class="filter__button btn btn-secondary btn-svg <?= $currentCategory === 'dishes' ? 'active' : '' ?>">
                                ...
                                <span class="sm-hidden">Plats</span>
                            </a>
                        </li>
                        <li>
                            <a href="?category=sides" class="filter__button btn btn-secondary btn-svg <?= $currentCategory === 'sides' ? 'active' : '' ?>">
                                <svg class="svg-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
                                ...
                                <span class="sm-hidden">Sides</span>
                            </a>
                        </li>
                        <li>
                            <a href="?category=desserts" class="filter__button btn btn-secondary btn-svg <?= $currentCategory === 'desserts' ? 'active' : '' ?>">
                                <svg class="svg-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
                                ...
                                <span class="sm-hidden">Desserts</span>
                            </a>
                        </li>
                        <li>
                            <a href="?category=drinks" class="filter__button btn btn-secondary btn-svg <?= $currentCategory === 'drinks' ? 'active' : '' ?>">
                                <svg class="svg-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
                                ...
                                <span class="sm-hidden">Boissons</span>
                            </a>
                        </li>
                    </ul>
                </div>
            </section>
            <section id="products__card" class="flex-col gap-20 w-full">
                <?php echo render_category_dish($currentCategory); ?>
            </section>
        </main>
